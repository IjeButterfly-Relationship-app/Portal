      ...
      <div className="play-header__left">
        <button className="play-header__logo" onClick={() => navigate("/")}>
          <svg viewBox="0 0 24 24" className="play-logo">
            ...
            <path fill="#FBBC05" d="M20.548 10.273L6.345 1.146A1.002 1.002 0 0 0 5.003 2v20c0 .75.83 1.204 1.46.817l14.202-9.127a1 1 0 0 0-.117-1.717z"/>
            <path fill="#4285F4" d="M3.609 1.814c-.37.21-.609.606-.609 1.03v18.312c0 .423.239.82.609 1.03l10.597-10.597L3.609 1.814z"/>
            <path fill="#34A853" d="M3.609 22.186l10.597-10.186 6.253 5.983L6.34 22.854a1 1 0 0 1-1.46-.817l-.271-.851z"/>
          </svg>
    ...
    <div className="screenshots-container">
      <div className="screenshot-card screenshot-card--featured">
        <div className="screenshot-card__content">
          ...
          <p className="screenshot-text">Find compatible partners who share your values and relationship goals.</p>
        </div>
...
const AboutSection = () => (
  <section className="app-about">
    ...
    <p className="about-text">
      Butterfly is the world's most intuitive relationship app, designed to help you 
      build meaningful habits, spark deep conversations, and grow closer every day. 
      With verified profiles, relationship coaching, and a secure private vault, 
      Butterfly gives you everything you need to find and nurture real love.
    </p>

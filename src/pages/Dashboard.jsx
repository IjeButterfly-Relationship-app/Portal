        ...
        <div className="content-area">
          ...
          <div className="analytics-row">
            ...
            <div className="side-cards">
              ...
              {/* Security Alerts */}
              <div className="security-alerts-card pink-theme">
                <div className="security-alerts-header">
                  <img src="/security.png" alt="" className="security-icon" />
                  <h3 className="security-alerts-title white-title">Security Alerts</h3>
                </div>
